...
const errorOutput = document.body.querySelector("header .errorOutput");

// alle Movies aus dem Array im HTML anzeigen
...
// Sortierfunktion nach Jahr absteigend
const yearDown = () => {
  movieOutput.innerHTML = ``;
...
// Sortierfunktion nach Bewertung absteigend
const bestRate = () => {
  movieOutput.innerHTML = ``;
